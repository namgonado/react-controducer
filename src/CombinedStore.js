...
import { STORE_CONFIG_TYPE, createStoreConfig } from "./StoreConfiguration"

export function COMBINE_STORE_TYPE() {}
Object.freeze(COMBINE_STORE_TYPE.prototype)

export function combineStores(mainStore, subStores) {
